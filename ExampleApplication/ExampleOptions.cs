namespace ExampleApplication
{
    ...
    abstract class ExampleOptions
    {
        ...
        [Remark("For more information regarding chunk sizes, consult the manual.", Order = 0)]
        ...
        [Usage(@"""output file.txt"" -dF XML", "Writes a file in XML format, including debug information.", Order = 1)]
        [Usage(@"""output file.txt""", "Writes a file with standard settings.", Order = 0)]
